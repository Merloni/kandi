...
\title{Optinen käsinkirjoitetun tekstin merkintunnistus koneoppimisessa}
...
Kirjoitetun tekstin kääntäminen tietokoneen ymmärtämään muotoon on ongelma, jota tietojenkäsittelytieteen ammattilaiset ovat yrittänneet ratkaista ja useita kymmeniä vuosia. Kirjoitus- tai tietokoneella tehtyä tekstiä on kyetty kääntämään suhteellisen tarkasti jo jonkin aikaa, mutta käsinkirjoitetun tekstin tunnistaminen on vieläkin vailla täydellistä ratkaisua.
Keskityn tässä tutkielmassa käsittelemään aluksi optista tekstintunnista yleisellä tasolla ja sitten keskityn sen sovelluksiin koneoppimisessa.

TODO lisää ku tietää mitä tekee
