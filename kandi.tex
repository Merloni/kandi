...
Optista merkintunnistusta (OCR) käytetään muuttamaan skannattujen ja tyypillisesti konekirjoitettujen dokumenttien sisältö tietokoneen luettavaan ASCII merkistöön. Tämä mahdollistaa tekstin muokkaamisen, lukemisen ja säilömisen huomattavasti tehokkaammalla tavalla.

Hyvin suuri osa arkipäiväisesti informaatiosta ei kuitenkaan ilmene dokumenteissa vaan esimerkiksi liikkeiden julkisivuissa tai tiekulteissä.
OCR ei toimi tällaisissa luonnollisissa tilanteissa yhtä hyvin, sillä tyypillisesti OCR-ratkaisut vaativat toimiakseen mustavalkoisen, tasaisen, linjoihin perustuvan ympäristön.


Keskityn tässä tutkielmassa käsittelemään aluksi optisen tekstintunnistuksen käyttöön ja ongelmiin yleisellä tasolla. Seuraavissa kappaleissa käsittelen optisen merkkitunnistuksen sovelluksia koneoppimisessa.
